...
<body>
                ...
                @foreach ($seminars as $seminar)
                    ...
                    <div class="card mb-3">
                        <div class="card-header p-0">
                            <div class="embed-responsive embed-responsive-16by9 custom-img-container custom-img">
                                <img src="\assets\img\Poster Sendikom 2024.png" class="card-img-top img-fluid"
                                    alt="Event Image">
                            </div>
                        </div>
                        <div class="card-body">
                            <p class="card-title">{{$seminar->nama_seminar}}</p>
                            <p class="card-text">{{$seminar->deskripsi}}</p>
                        </div>
                    </div>
                @endforeach
    ...
    <footer id="footer" class="footer">
        ...
        <div class="credits">
            Designed by <a href="about.blade.php">Team Tickers</a>
        </div>
    </footer><!-- End Footer -->
