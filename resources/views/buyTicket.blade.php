                        ...
                        @foreach ($seminars as $seminar)
                            <div class="col-xxl-4 col-xl-12">
                                ...
                                <div class="card info-card customers-card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Created By <span>| PILKOM</span></h5>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                <h6><a href="infoBuyTicket">{{$seminar->nama_seminar}}</a></h6>
                                                <span class="text-muted small pt-2 ps-1">{{$seminar->deskripsi}}</span>
