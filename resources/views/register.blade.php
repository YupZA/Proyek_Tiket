            ...
            <div class="col">
                <form method="post" action="{{ route('register.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('namaInput') is-invalid @enderror" id="namaInput"
                            name="namaInput" value="{{ old('namaInput') }}">
                        @error('namaInput')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nimInput') is-invalid @enderror" id="nimInput"
                            name="nimInput" value="{{ old('nimInput') }}">
                        @error('nimInput')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
